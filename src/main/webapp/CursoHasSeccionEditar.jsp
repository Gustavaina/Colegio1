      ...
      MatriculaBean aBE = new MatriculaBean();
       ...
       if("EDIT".equalsIgnoreCase(request.getParameter("accion")) 
        && request.getParameter("id") != null ){
          ...
          oSeccionController.SelectByCodigo(request.getParameter("id"));
           ...
           Curso:<br>
            ...
            <select name="txt_docente" class="form-control mb-2">
                ...
                <select class="form-control mb-4" name="txt_estado">
                    ...
                    <a class="btn btn-danger" href="CursoHasSeccionListar.jsp"><i class="fas fa-cancel fa-xs"></i> Cancelar</a>
            </form>
        </div>
    </body>
</html>