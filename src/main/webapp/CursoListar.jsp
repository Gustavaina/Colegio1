...
<head>
    ...
    <script>
        function llenarFormulario(aula_id, cursosec_id, curso_matematica, curso_fisica, curso_redaccion, curso_historia, curso_tutoria, curso_ciencias, curso_ingles, curso_edu_fisica) {
            ...
            document.getElementById("curso_id").value = cursosec_id;
...
<%
    ...
    if ("insertar".equals(accion)) {
        ...
        boolean resultado = metodos.eliminarCursoporcursoid(cursoId);
        ...
        boolean resultado = metodos.actualizarCursoSec(aula_id, curso_matematica, curso_fisica, curso_redaccion, curso_historia, curso_tutoria, curso_ciencias, curso_ingles, curso_edu_fisica, curso_id);
    ...
    %>
                <tr>
                    ...
                    <td>
                        ...
                        <button onclick="llenarFormulario('<%= aula_id %>', '<%= cursosec_id %>', '<%= curso_matematica %>', '<%= curso_fisica %>', '<%= curso_redaccion %>', '<%= curso_historia %>', '<%= curso_tutoria %>', '<%= curso_ciencias %>', '<%= curso_ingles %>', '<%= curso_edu_fisica %>')">Editar</button>
                    </td>
                </tr>
    <%
            }
